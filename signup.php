            ...
            <div class="card-body">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "INSERT INTO account_establishment (email, password, name, address, map, cover_photo, permit_file, price, status, contact, payment_details, type, type_option, near) 
                            VALUES ('$email', '$password', '$name', '$address', '$map', '$target_file_cover', '$target_file_permit', '$price', '$status', '$contact', '$payment_details', '$type', '$type_option', '$near')";
                    ...
                    if (mysqli_query($conn, $sql)) {
                        ...
                        $target_dir = "uploads/room_videos/" . $last_id . "/"; // Set your upload directory
                        ...
                        if (move_uploaded_file($_FILES["video"]["tmp_name"], $target_file_video)) {
                            ...
                            echo "<div class='alert alert-danger'>Error uploading 'Video of apartment' file.</div>";
                        }
